...
1. Identification of the relevant data
2. Deciding on geography for which to download data
3. Sourcing
4. Pre-processing and feeding data for analysis

## Data Selection

The package comes with an embedded data sets containing list of data and geographies available through the [statistics.gov.scot](http://statistics.gov.scot) endpoint. To see the list of available data sets refer to the `data("available_data_sets")` objects. For the **life expectancy** data it's 
